 ...
 *
 * API for the xk_voice_sq66 board.
 * @{
 */
 ...
 *  @var xk_voice_sq66_config_t::pcm_format
 *      See xk_voice_sq66_pcm_format_t for available data frame options.
 *  @var xk_voice_sq66_config_t::i2s_n_bits
 *      Number of bits per data frame in I2S.
 *  @var xk_voice_sq66_config_t::i2s_chans_per_frame
...
/** 
 * @brief Starts an I2C master task. Must be started from tile[0] *after* xk_voice_sq66_board_setup() and *before* and tile[1] HW calls.
 *
 ...
 *  and *before* xk_voice_sq66_AudioHwInit() is called.
 *
 ...
 * xk_voice_sq66_board_setup() and xk_voice_sq66_AudioHwInit must be called once 
 ...
 *  HW config calls from tile[1] will block forever. It is possible to re-start xk_voice_sq66_i2c_master()
